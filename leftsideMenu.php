...
<!--  <div class="table-responsive"> 
  ...
  <table class="table table-hover table-condensed" style = "color:#F5F5F5">
    ...
    <tbody>
      ...
      <tr>
		 ...
		 <td>  Electronics Gadgets <a href = "electronics.php"><img src="img/s2.png" class="img-thumbnail" width= "100" height= "100"></img> </td>
        
      </tr>
      <tr>
        
		 <td>Fashion <img src="img/fashion.png" class="img-thumbnail" width= "100" height= "100"></img></a> </td>
        
      </tr>
      <tr>
       
		 <td>Season based shopping <a href = "Seasonshopping.php"><img src="img/s4.png" class="img-thumbnail" width= "100" height= "100"></img> </a></td>
      </tr>
    </tbody>
  </table>
</div>
